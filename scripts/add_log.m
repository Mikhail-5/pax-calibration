...
filename = [
    % "C:\Users\Mikhail.Nuzhnov\Downloads\www\thermal_calib_2026-02-09_11-21-43.log"
    % "C:\Users\Mikhail.Nuzhnov\Downloads\www\rotplateVert25Hz_.py_2026-02-10_11-56-12.log"
    % "C:\Users\Mikhail.Nuzhnov\Downloads\www\rotplateVert100Hz_2026-02-10_11-33-47.log"
    % "C:\Users\Mikhail.Nuzhnov\Downloads\www\rotplateHor100Hz_2026-02-10_10-42-51.log"
    % "C:\Users\Mikhail.Nuzhnov\Downloads\www\rotplateHor25Hz_2026-02-10_10-21-17.log"
    % "C:\Users\Mikhail.Nuzhnov\Downloads\www\cubeCalib_L322R016_2026-02-10_17-24-17.log"
    % "C:\Users\Mikhail.Nuzhnov\Downloads\www\meas_parallel.py_2026-02-11_14-36-52.log"
    % "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-03-01_17-08-38.log"
    % "C:\Projects\PAX_calib_data\data\cube_calib_2026-03-01_18-09-26.log"
    % "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-03-05_19-35-04.log"
    % "C:\Users\Mikhail.Nuzhnov\Downloads\indoor_cycling30min_and_8h_rest_2026-03-08_22-33-33.log"
    % "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-03-09_12-34-54.log"
    % "C:\Projects\PAX_calib_data\data\meas_axles_and_GSV.py_2026-03-10_19-33-29.log"
    % "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-03-12_09-05-02.log"
    % "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-03-09_19-25-51.log"
    % "C:\Projects\PAX_Drift_Testbench\python\logs\meas_parallel.py_2026-03-12_19-39-08.log" % fails 01.01.00/01/002211, 100 Hz
    % "C:\Projects\PAX_Drift_Testbench\python\logs\meas_parallel.py_2026-03-12_19-43-45.log" % fails 01.01.00/01/002211, 25 Hz
    % "C:\Projects\PAX_calib_data\data\meas_axles_and_GSV.py_2026-03-13_17-30-09.log"
    % "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-03-14_17-59-48.log"
    % "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-03-14_17-49-22.log"
    % "C:\Projects\PAX_calib_data\data\meas_axles_and_GSV.py_2026-03-14_18-42-09.log"
    % "C:\Projects\PAX_common_data\meas_parallel.py_2026-03-13_12-23-57.log"
    % "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-03-15_21-56-56.log"
    % "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-03-16_14-55-24.log" % cube calib
    % "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-03-16_15-02-48.log" % % rot plate calib
    % "C:\Projects\PAX_calib_data\data\meas_axles_and_GSV.py_2026-03-16_21-51-46.log" % force calib
    % "C:\Projects\PAX_calib_data\data\meas_axles_and_GSV.py_2026-03-16_22-44-16.log" % force calib
    % "C:\Projects\PAX_calib_data\data\meas_axles_and_GSV.py_2026-03-19_11-02-34.log" % force calib
    % "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-03-20_11-04-52.log" % temp calib - 2 axles
    % "C:\Projects\PAX_calib_data\data\meas_axles_and_GSV.py_2026-03-21_10-53-59.log" % force calib
    % "C:\Projects\PAX_calib_data\data\meas_axles_and_GSV.py_2026-03-21_11-37-43.log" % force calib
    % "C:\Projects\PAX_common_data\indoor_2pedals_Chemnitz__2026-04-05_21-31-02.log"
    % "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-05-09_16-49-26.log" % temp calib
    % % % % % % % % % "C:\Projects\PAX_calib_data\data\meas_axles_and_GSV.py_2026-05-09_16-12-24.log"
    % "C:\Projects\PAX_calib_data\data\meas_axles_and_GSV.py_2026-05-09_14-59-14.log" % force calib
    % "C:\Projects\PAX_calib_data\data\force_calib_combined_2026-05-09_16-26-47.log" % force calib
    % "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-05-09_12-50-23.log" %cube calib 25 Hz
    % "C:\Projects\PAX_py_tools\logs\meas_parallel.py_2026-05-09_12-42-42.log" garbage
% "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-05-09_12-25-35.log"  % Rotating plate calibration 25 Hz
% "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-05-09_12-37-03.log" % Rotating plate calibration 50 Hz
% "C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-05-10_16-32-59.log" % Rotating plate calibration 50 Hz - 1 axle
"C:\Projects\PAX_calib_data\data\meas_parallel.py_2026-05-23_22-58-42.log"
% 
    ]; %#ok<NBRAK2>
...
for axle_i = 1:length(reader.data)
    disp(IDs(axle_i)+ " - "+ string(length(uint64(reader.data{axle_i}.BMI.Sample.data)))+ " samples");
    system('""C:\Programs\Notepad++\notepad++.exe"" "' + history_paths(axle_i) + '"');
end
return;0;
%% display MAC and ID (sorted by ID)
for ID = sort(IDs)'
    [ID, MAC] = ID2MAC(ID);
    disp(""+'"'+MAC+'", # "'+ID+'"')
end
...
for ID = [
    ...
    disp(ID);
    system('""C:\Programs\Notepad++\notepad++.exe"" "' + coefFolder+"\"+ID+"\history.md" + '"');
end
